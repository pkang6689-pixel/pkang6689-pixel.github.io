...
(function () {
  ...
  // AP course URL detection: map AP subject subfolder to course homepage
  if (lessonFolder === 'APLessons') {
    var apSubjectMap = {
      'AP Biology': 'ap_biology.html', 'AP Calculus AB': 'ap_calculus.html',
      'AP Chemistry': 'ap_chemistry.html', 'AP Environmental Science': 'ap_environmental_science.html',
      'AP Human Geography': 'ap_hug.html', 'AP Physics 1': 'ap_physics1.html',
      'AP Physics 2': 'ap_physics2.html', 'AP Physics C - Mechanics': 'ap_physics_mechanics.html',
      'AP Statistics': 'ap_statistics.html'
    };
    for (var ai = 0; ai < parts.length; ai++) {
      if (parts[ai] === 'APLessons' && ai + 1 < parts.length) {
        var apSubject = decodeURIComponent(parts[ai + 1]);
        var apPage = apSubjectMap[apSubject];
        if (apPage) courseMap['APLessons'] = '/ArisEdu Project Folder/CourseHomepage/' + apPage;
        break;
      }
    }
  }
  ...
  // All back navigation is handled inline next to "Next Up:" — taskbar button hidden for all lesson types
  if (filename.indexOf('_Practice') !== -1) {
    ...
    showBack = false;
  } else if (filename.indexOf('_Simulation') !== -1) {
    backText = '\u2190 Back to Summary';
    backUrl = filename.replace('_Simulation.html', '_Summary.html');
    showBack = false;
...
,
        'ChemistryLessons:1.2': { label: 'Simulation', icon: '🧪' },
        'ChemistryLessons:3.3': { label: 'Simulation', icon: '⚛️' },
        'ChemistryLessons:4.6': { label: 'Simulation', icon: '📊' },
        'ChemistryLessons:4.8': { label: 'Simulation', icon: '🔬' },
        'ChemistryLessons:6.1': { label: 'Simulation', icon: '🧪' },
        'ChemistryLessons:6.3': { label: 'Simulation', icon: '⚡' },
        'ChemistryLessons:6.6': { label: 'Simulation', icon: '⏱️' },
        'ChemistryLessons:6.7': { label: 'Simulation', icon: '⚖️' },
        'ChemistryLessons:7.7': { label: 'Simulation', icon: '🧮' },
        'ChemistryLessons:8.4': { label: 'Simulation', icon: '⚗️' },
        'ChemistryLessons:9.4': { label: 'Simulation', icon: '🧪' },
        'ChemistryLessons:10.6': { label: 'Simulation', icon: '🧪' },
        'ChemistryLessons:10.9': { label: 'Simulation', icon: '🧪' },
        'ChemistryLessons:11.4': { label: 'Simulation', icon: '🌡️' },
        'ChemistryLessons:12.2': { label: 'Simulation', icon: '☢️' },
        'PhysicsLessons:2.5': { label: 'Simulation', icon: '🎯' },
        'PhysicsLessons:3.6': { label: 'Simulation', icon: '📐' },
        'PhysicsLessons:3.7': { label: 'Simulation', icon: '🔄' },
        'PhysicsLessons:5.4': { label: 'Simulation', icon: '💥' },
        'PhysicsLessons:7.1': { label: 'Simulation', icon: '🌀' },
        'PhysicsLessons:7.2': { label: 'Simulation', icon: '🕰️' },
        'PhysicsLessons:7.4': { label: 'Simulation', icon: '〰️' },
        'PhysicsLessons:7.6': { label: 'Simulation', icon: '〰️' },
        'PhysicsLessons:7.7': { label: 'Simulation', icon: '🔊' },
        'PhysicsLessons:9.1': { label: 'Simulation', icon: '🔦' },
        'PhysicsLessons:10.2': { label: 'Simulation', icon: '⚡' },
        'PhysicsLessons:10.4': { label: 'Simulation', icon: '💡' },
        'PhysicsLessons:10.6': { label: 'Simulation', icon: '🧲' },
        'BiologyLessons:2.6': { label: 'Simulation', icon: '🌍' },
        'BiologyLessons:4.5': { label: 'Simulation', icon: '🌿' },
        'BiologyLessons:5.3': { label: 'Simulation', icon: '🌳' },
        'BiologyLessons:6.2': { label: 'Simulation', icon: '🔬' },
        'BiologyLessons:6.4': { label: 'Simulation', icon: '🧫' },
        'BiologyLessons:8.3': { label: 'Simulation', icon: '🌱' },
        'BiologyLessons:9.3': { label: 'Simulation', icon: '🔬' },
        'BiologyLessons:10.1': { label: 'Simulation', icon: '🔬' },
        'BiologyLessons:11.1': { label: 'Simulation', icon: '🧬' },
        'BiologyLessons:12.2': { label: 'Simulation', icon: '🧬' },
        'BiologyLessons:12.4': { label: 'Simulation', icon: '🧬' },
        'AnatomyLessons:4.2': { label: 'Simulation', icon: '🧠' },
        'AnatomyLessons:6.1': { label: 'Simulation', icon: '❤️' },
        'AnatomyLessons:7.1': { label: 'Simulation', icon: '🫁' },
        'AnatomyLessons:8.1': { label: 'Simulation', icon: '🫀' },
        'AnatomyLessons:10.1': { label: 'Simulation', icon: '🛡️' },
        'EarthScienceLessons:1.2': { label: 'Simulation', icon: '💎' },
        'EarthScienceLessons:1.4': { label: 'Simulation', icon: '🪨' },
        'EarthScienceLessons:1.5': { label: 'Simulation', icon: '🌱' },
        'EarthScienceLessons:2.4': { label: 'Simulation', icon: '📍' },
        'EarthScienceLessons:2.5': { label: 'Simulation', icon: '🌋' },
        'EarthScienceLessons:3.2': { label: 'Simulation', icon: '🏜️' },
        'EarthScienceLessons:3.4': { label: 'Simulation', icon: '🏔️' },
        'EarthScienceLessons:4.4': { label: 'Simulation', icon: '🦕' },
        'EarthScienceLessons:5.1': { label: 'Simulation', icon: '🌤️' },
        'EarthScienceLessons:5.5': { label: 'Simulation', icon: '⛈️' },
        'EarthScienceLessons:6.3': { label: 'Simulation', icon: '🌐' },
        'EarthScienceLessons:6.4': { label: 'Simulation', icon: '♻️' },
        'MarineScienceLessons:1.1': { label: 'Simulation', icon: '🌊' },
        'MarineScienceLessons:2.1': { label: 'Simulation', icon: '🧂' },
        'MarineScienceLessons:2.2': { label: 'Simulation', icon: '🌊' },
        'MarineScienceLessons:2.3': { label: 'Simulation', icon: '🌕' },
        'MarineScienceLessons:2.4': { label: 'Simulation', icon: '🏖️' },
        'MarineScienceLessons:3.5': { label: 'Simulation', icon: '🌋' },
        'MarineScienceLessons:4.3': { label: 'Simulation', icon: '⚗️' },
        'MarineScienceLessons:5.2': { label: 'Simulation', icon: '🐟' },
        'MarineScienceLessons:5.3': { label: 'Simulation', icon: '🦠' },
        'MarineScienceLessons:5.5': { label: 'Simulation', icon: '🌿' },
        'MarineScienceLessons:7.5': { label: 'Simulation', icon: '🐋' },
        'MarineScienceLessons:8.2': { label: 'Simulation', icon: '🛢️' },
        'MarineScienceLessons:8.3': { label: 'Simulation', icon: '🪸' },
        'MarineScienceLessons:9.3': { label: 'Simulation', icon: '✨' },
        'AstronomyLessons:2.2': { label: 'Simulation', icon: '🌍' },
        'AstronomyLessons:2.3': { label: 'Simulation', icon: '🌙' },
        'AstronomyLessons:3.1': { label: 'Simulation', icon: '☀️' },
        'AstronomyLessons:3.8': { label: 'Simulation', icon: '🪐' },
        'AstronomyLessons:5.2': { label: 'Simulation', icon: '⭐' },
        'AstronomyLessons:5.3': { label: 'Simulation', icon: '✨' },
        'AstronomyLessons:5.7': { label: 'Simulation', icon: '⚫' },
        'AstronomyLessons:6.1': { label: 'Simulation', icon: '🌌' },
        'AstronomyLessons:6.5': { label: 'Simulation', icon: '📡' },
        'AstronomyLessons:7.5': { label: 'Simulation', icon: '🚀' },
        'AstronomyLessons:8.5': { label: 'Simulation', icon: '🌍' },
        'AstronomyLessons:9.1': { label: 'Simulation', icon: '🔭' },
        'AstronomyLessons:9.4': { label: 'Simulation', icon: '🌈' },
        'GeometryLessons:5.1': { label: 'Simulation', icon: '📐' },
        'GeometryLessons:7.8': { label: 'Simulation', icon: '🌀' },
        'GeometryLessons:9.1': { label: 'Simulation', icon: '🔄' },
        'GeometryLessons:9.2': { label: 'Simulation', icon: '🔄' },
        'GeometryLessons:9.3': { label: 'Simulation', icon: '🔄' },
        'GeometryLessons:10.9': { label: 'Simulation', icon: '📈' },
        'Algebra1Lessons:6.1': { label: 'Simulation', icon: '📈' },
        'Algebra1Lessons:12.1': { label: 'Simulation', icon: '🎲' },
        'Algebra2Lessons:1.2': { label: 'Simulation', icon: '📏' },
        'Algebra2Lessons:3.6': { label: 'Simulation', icon: '🔢' },
        'Algebra2Lessons:9.1': { label: 'Simulation', icon: '📈' },
        'Algebra2Lessons:9.3': { label: 'Simulation', icon: '➡️' },
        'TrigonometryLessons:1.5': { label: 'Simulation', icon: '⭕' },
        'TrigonometryLessons:8.1': { label: 'Simulation', icon: '🌀' },
        'TrigonometryLessons:9.1': { label: 'Simulation', icon: '➡️' },
        'StatisticsLessons:2.4': { label: 'Simulation', icon: '📊' },
        'StatisticsLessons:4.1': { label: 'Simulation', icon: '🎲' },
        'LinearAlgebraLessons:1.4': { label: 'Simulation', icon: '🔢' }
,
        'ChemistryLessons:1.2': { label: 'Simulation', icon: '🧪' },
        'ChemistryLessons:3.3': { label: 'Simulation', icon: '⚛️' },
        'ChemistryLessons:4.6': { label: 'Simulation', icon: '📊' },
...
,
      ...
      // Override Practice back URL if this lesson has a simulation
      if (filename.indexOf('_Practice') !== -1 && !filename.includes('Test') && tbHasSim) {
        backUrl = filename.replace('_Practice.html', '_Simulation.html');
        backText = '\u2190 Back to Simulation';
      }
      var tbSteps = [
...
,
      'ChemistryLessons:1.2': { label: 'Simulation', icon: '🧪', url: baseName + '_Simulation.html' },
      'ChemistryLessons:3.3': { label: 'Simulation', icon: '⚛️', url: baseName + '_Simulation.html' },
      'ChemistryLessons:4.6': { label: 'Simulation', icon: '📊', url: baseName + '_Simulation.html' },
      'ChemistryLessons:4.8': { label: 'Simulation', icon: '🔬', url: baseName + '_Simulation.html' },
      'ChemistryLessons:6.1': { label: 'Simulation', icon: '🧪', url: baseName + '_Simulation.html' },
      'ChemistryLessons:6.3': { label: 'Simulation', icon: '⚡', url: baseName + '_Simulation.html' },
      'ChemistryLessons:6.6': { label: 'Simulation', icon: '⏱️', url: baseName + '_Simulation.html' },
      'ChemistryLessons:6.7': { label: 'Simulation', icon: '⚖️', url: baseName + '_Simulation.html' },
      'ChemistryLessons:7.7': { label: 'Simulation', icon: '🧮', url: baseName + '_Simulation.html' },
      'ChemistryLessons:8.4': { label: 'Simulation', icon: '⚗️', url: baseName + '_Simulation.html' },
      'ChemistryLessons:9.4': { label: 'Simulation', icon: '🧪', url: baseName + '_Simulation.html' },
      'ChemistryLessons:10.6': { label: 'Simulation', icon: '🧪', url: baseName + '_Simulation.html' },
      'ChemistryLessons:10.9': { label: 'Simulation', icon: '🧪', url: baseName + '_Simulation.html' },
      'ChemistryLessons:11.4': { label: 'Simulation', icon: '🌡️', url: baseName + '_Simulation.html' },
      'ChemistryLessons:12.2': { label: 'Simulation', icon: '☢️', url: baseName + '_Simulation.html' },
      'PhysicsLessons:2.5': { label: 'Simulation', icon: '🎯', url: baseName + '_Simulation.html' },
      'PhysicsLessons:3.6': { label: 'Simulation', icon: '📐', url: baseName + '_Simulation.html' },
      'PhysicsLessons:3.7': { label: 'Simulation', icon: '🔄', url: baseName + '_Simulation.html' },
      'PhysicsLessons:5.4': { label: 'Simulation', icon: '💥', url: baseName + '_Simulation.html' },
      'PhysicsLessons:7.1': { label: 'Simulation', icon: '🌀', url: baseName + '_Simulation.html' },
      'PhysicsLessons:7.2': { label: 'Simulation', icon: '🕰️', url: baseName + '_Simulation.html' },
      'PhysicsLessons:7.4': { label: 'Simulation', icon: '〰️', url: baseName + '_Simulation.html' },
      'PhysicsLessons:7.6': { label: 'Simulation', icon: '〰️', url: baseName + '_Simulation.html' },
      'PhysicsLessons:7.7': { label: 'Simulation', icon: '🔊', url: baseName + '_Simulation.html' },
      'PhysicsLessons:9.1': { label: 'Simulation', icon: '🔦', url: baseName + '_Simulation.html' },
      'PhysicsLessons:10.2': { label: 'Simulation', icon: '⚡', url: baseName + '_Simulation.html' },
      'PhysicsLessons:10.4': { label: 'Simulation', icon: '💡', url: baseName + '_Simulation.html' },
      'PhysicsLessons:10.6': { label: 'Simulation', icon: '🧲', url: baseName + '_Simulation.html' },
      'BiologyLessons:2.6': { label: 'Simulation', icon: '🌍', url: baseName + '_Simulation.html' },
      'BiologyLessons:4.5': { label: 'Simulation', icon: '🌿', url: baseName + '_Simulation.html' },
      'BiologyLessons:5.3': { label: 'Simulation', icon: '🌳', url: baseName + '_Simulation.html' },
      'BiologyLessons:6.2': { label: 'Simulation', icon: '🔬', url: baseName + '_Simulation.html' },
      'BiologyLessons:6.4': { label: 'Simulation', icon: '🧫', url: baseName + '_Simulation.html' },
      'BiologyLessons:8.3': { label: 'Simulation', icon: '🌱', url: baseName + '_Simulation.html' },
      'BiologyLessons:9.3': { label: 'Simulation', icon: '🔬', url: baseName + '_Simulation.html' },
      'BiologyLessons:10.1': { label: 'Simulation', icon: '🔬', url: baseName + '_Simulation.html' },
      'BiologyLessons:11.1': { label: 'Simulation', icon: '🧬', url: baseName + '_Simulation.html' },
      'BiologyLessons:12.2': { label: 'Simulation', icon: '🧬', url: baseName + '_Simulation.html' },
      'BiologyLessons:12.4': { label: 'Simulation', icon: '🧬', url: baseName + '_Simulation.html' },
      'AnatomyLessons:4.2': { label: 'Simulation', icon: '🧠', url: baseName + '_Simulation.html' },
      'AnatomyLessons:6.1': { label: 'Simulation', icon: '❤️', url: baseName + '_Simulation.html' },
      'AnatomyLessons:7.1': { label: 'Simulation', icon: '🫁', url: baseName + '_Simulation.html' },
      'AnatomyLessons:8.1': { label: 'Simulation', icon: '🫀', url: baseName + '_Simulation.html' },
      'AnatomyLessons:10.1': { label: 'Simulation', icon: '🛡️', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:1.2': { label: 'Simulation', icon: '💎', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:1.4': { label: 'Simulation', icon: '🪨', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:1.5': { label: 'Simulation', icon: '🌱', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:2.4': { label: 'Simulation', icon: '📍', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:2.5': { label: 'Simulation', icon: '🌋', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:3.2': { label: 'Simulation', icon: '🏜️', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:3.4': { label: 'Simulation', icon: '🏔️', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:4.4': { label: 'Simulation', icon: '🦕', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:5.1': { label: 'Simulation', icon: '🌤️', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:5.5': { label: 'Simulation', icon: '⛈️', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:6.3': { label: 'Simulation', icon: '🌐', url: baseName + '_Simulation.html' },
      'EarthScienceLessons:6.4': { label: 'Simulation', icon: '♻️', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:1.1': { label: 'Simulation', icon: '🌊', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:2.1': { label: 'Simulation', icon: '🧂', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:2.2': { label: 'Simulation', icon: '🌊', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:2.3': { label: 'Simulation', icon: '🌕', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:2.4': { label: 'Simulation', icon: '🏖️', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:3.5': { label: 'Simulation', icon: '🌋', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:4.3': { label: 'Simulation', icon: '⚗️', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:5.2': { label: 'Simulation', icon: '🐟', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:5.3': { label: 'Simulation', icon: '🦠', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:5.5': { label: 'Simulation', icon: '🌿', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:7.5': { label: 'Simulation', icon: '🐋', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:8.2': { label: 'Simulation', icon: '🛢️', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:8.3': { label: 'Simulation', icon: '🪸', url: baseName + '_Simulation.html' },
      'MarineScienceLessons:9.3': { label: 'Simulation', icon: '✨', url: baseName + '_Simulation.html' },
      'AstronomyLessons:2.2': { label: 'Simulation', icon: '🌍', url: baseName + '_Simulation.html' },
      'AstronomyLessons:2.3': { label: 'Simulation', icon: '🌙', url: baseName + '_Simulation.html' },
      'AstronomyLessons:3.1': { label: 'Simulation', icon: '☀️', url: baseName + '_Simulation.html' },
      'AstronomyLessons:3.8': { label: 'Simulation', icon: '🪐', url: baseName + '_Simulation.html' },
      'AstronomyLessons:5.2': { label: 'Simulation', icon: '⭐', url: baseName + '_Simulation.html' },
      'AstronomyLessons:5.3': { label: 'Simulation', icon: '✨', url: baseName + '_Simulation.html' },
      'AstronomyLessons:5.7': { label: 'Simulation', icon: '⚫', url: baseName + '_Simulation.html' },
      'AstronomyLessons:6.1': { label: 'Simulation', icon: '🌌', url: baseName + '_Simulation.html' },
      'AstronomyLessons:6.5': { label: 'Simulation', icon: '📡', url: baseName + '_Simulation.html' },
      'AstronomyLessons:7.5': { label: 'Simulation', icon: '🚀', url: baseName + '_Simulation.html' },
      'AstronomyLessons:8.5': { label: 'Simulation', icon: '🌍', url: baseName + '_Simulation.html' },
      'AstronomyLessons:9.1': { label: 'Simulation', icon: '🔭', url: baseName + '_Simulation.html' },
      'AstronomyLessons:9.4': { label: 'Simulation', icon: '🌈', url: baseName + '_Simulation.html' },
      'GeometryLessons:5.1': { label: 'Simulation', icon: '📐', url: baseName + '_Simulation.html' },
      'GeometryLessons:7.8': { label: 'Simulation', icon: '🌀', url: baseName + '_Simulation.html' },
      'GeometryLessons:9.1': { label: 'Simulation', icon: '🔄', url: baseName + '_Simulation.html' },
      'GeometryLessons:9.2': { label: 'Simulation', icon: '🔄', url: baseName + '_Simulation.html' },
      'GeometryLessons:9.3': { label: 'Simulation', icon: '🔄', url: baseName + '_Simulation.html' },
      'GeometryLessons:10.9': { label: 'Simulation', icon: '📈', url: baseName + '_Simulation.html' },
      'Algebra1Lessons:6.1': { label: 'Simulation', icon: '📈', url: baseName + '_Simulation.html' },
      'Algebra1Lessons:12.1': { label: 'Simulation', icon: '🎲', url: baseName + '_Simulation.html' },
      'Algebra2Lessons:1.2': { label: 'Simulation', icon: '📏', url: baseName + '_Simulation.html' },
      'Algebra2Lessons:3.6': { label: 'Simulation', icon: '🔢', url: baseName + '_Simulation.html' },
      'Algebra2Lessons:9.1': { label: 'Simulation', icon: '📈', url: baseName + '_Simulation.html' },
      'Algebra2Lessons:9.3': { label: 'Simulation', icon: '➡️', url: baseName + '_Simulation.html' },
      'TrigonometryLessons:1.5': { label: 'Simulation', icon: '⭕', url: baseName + '_Simulation.html' },
      'TrigonometryLessons:8.1': { label: 'Simulation', icon: '🌀', url: baseName + '_Simulation.html' },
      'TrigonometryLessons:9.1': { label: 'Simulation', icon: '➡️', url: baseName + '_Simulation.html' },
      'StatisticsLessons:2.4': { label: 'Simulation', icon: '📊', url: baseName + '_Simulation.html' },
      'StatisticsLessons:4.1': { label: 'Simulation', icon: '🎲', url: baseName + '_Simulation.html' },
      'LinearAlgebraLessons:1.4': { label: 'Simulation', icon: '🔢', url: baseName + '_Simulation.html' }
,
      'ChemistryLessons:1.2': { label: 'Simulation', icon: '🧪', url: baseName + '_Simulation.html' },
      'ChemistryLessons:3.3': { label: 'Simulation', icon: '⚛️', url: baseName + '_Simulation.html' },
      'ChemistryLessons:4.6': { label: 'Simulation', icon: '📊', url: baseName + '_Simulation.html' },
...
,
  ...
  // === Inject back link inline next to "Next Up:" buttons — one step back in lesson sequence ===
  if (lessonFolder && backUrl) {
    var _injectBackToCourse = function() {
      var _url, _label;
      var _isVideoOrTest = filename.indexOf('_Video') !== -1 ||
        (filename.indexOf('_Practice') !== -1 && filename.indexOf('Test') !== -1);
      if (_isVideoOrTest) {
        _url = courseMap[lessonFolder] || '/ArisEdu Project Folder/Courses.html';
        var _courseFriendly = {
          ChemistryLessons: 'Chemistry', PhysicsLessons: 'Physics', BiologyLessons: 'Biology',
          Algebra1Lessons: 'Algebra 1', Algebra2Lessons: 'Algebra 2', GeometryLessons: 'Geometry',
          AnatomyLessons: 'Anatomy', AstronomyLessons: 'Astronomy',
        ...
        var _cn = _courseFriendly[lessonFolder] || lessonFolder.replace('Lessons','').trim();
        if (lessonFolder === 'APLessons') {
          var _apPage = _url.split('/').pop().replace('.html','');
          var _apNames = { 'ap_biology':'AP Biology','ap_calculus':'AP Calculus AB',
            'ap_chemistry':'AP Chemistry','ap_environmental_science':'AP Environmental Science',
            'ap_hug':'AP Human Geography','ap_physics1':'AP Physics 1',
            'ap_physics2':'AP Physics 2','ap_physics_mechanics':'AP Physics C',
            'ap_statistics':'AP Statistics' };
          _cn = _apNames[_apPage] || 'AP Course';
        }
        _label = '\u2190 Back to ' + _cn;
      } else {
        _url = backUrl;
      ...
      document.querySelectorAll('a.side-button').forEach(function(link) {
        if (link.textContent.indexOf('Next Up') === -1) return;
        // Don't inject if already present
        var prev = link.previousElementSibling;
        if (prev && prev.textContent.indexOf('Back to') !== -1) return;
        var backLink = document.createElement('a');
        backLink.className = 'side-button';
        backLink.href = _url;
        backLink.textContent = _label;
        backLink.style.cssText = 'text-decoration:none;text-align:center;display:block;';
        link.parentNode.insertBefore(backLink, link);
      });
    };
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', _injectBackToCourse);
    } else {
      _injectBackToCourse();
    }
  }
