...
def main():
    ...
    gen_trans = extract_from_file('scripts/generate_translations.py')
    if gen_trans:
    ...
    sum_trans = extract_from_file('scripts/generate_summary_translations.py')
    if sum_trans:
    ...
    inj_trans = extract_from_file('scripts/inject_translations.py')
    if inj_trans:
