#!/usr/bin/env python3
"""
Add missing Algebra 2 Chinese translations for all lessons
"""

# All Algebra 2 lessons with Simplified Chinese translations
ALGEBRA2_LESSONS_CHINESE = {
    # Unit 1
...
def add_chinese_translations():
    """Add missing Chinese translations to global_translations.js"""
    ...
    for key, translation in ALGEBRA2_LESSONS_CHINESE.items():
        if f'"{key}"' in content:
            already_present += 1
            continue
    ...
    print(f"✅ Added {added_count} Simplified Chinese translations for Algebra 2")
